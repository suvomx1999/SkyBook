...
const Register = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-64px)] bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl flex overflow-hidden flex-row-reverse">
        
        {/* Right Side - Image */}
        <div className="hidden md:block w-1/2 bg-blue-600 relative">
          <img 
            src="https://images.unsplash.com/photo-1542296332-2e44a785e755?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
            alt="Register background" 
            className="absolute inset-0 w-full h-full object-cover mix-blend-overlay opacity-50"
          />
          <div className="relative z-10 p-12 text-white h-full flex flex-col justify-center text-right">
            <h2 className="text-4xl font-bold mb-4">Join SkyBook</h2>
            <p className="text-blue-100 text-lg">
              Create an account to start your journey and unlock exclusive deals.
            </p>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 mt-2">Start your adventure today</p>
          </div>
